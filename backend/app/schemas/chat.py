...
class ChatRequest(BaseModel):
    ...
    problem_statement: Optional[str] = Field(None, description="Problem statement text")
    hints: Optional[str] = Field(None, description="Revealed hints text")
    editorial: Optional[str] = Field(None, description="Problem editorial text")
